...
const projectid = "2KZoc5u8mTnZMWemGDiumHtMGvC";
const projectSec = "8589537eb9a29b87cb4da5b1486c8a63";

const auth =
  "Basic " + Buffer.from(projectid + ":" + projectSec).toString("base64");
...
export const VotingProvider = ({ children }) => {
  ...
  const [voterLength, setVoterLength] = useState("10");
